...
# this is a important code snippet
...
def datreeINPUT(inputtweet):
    ...
    ## for dumping the pkl files
    ##pickle.dump(vectorizer.pkl, vec)
    with open('vectorizer.pkl', 'wb') as f:
         pickle.dump(vectorizer, f)
    ##pickle.dump(dtree.pkl,model)
    with open('dtree.pkl', 'wb') as f:
         pickle.dump(dtree, f)

    ## for loading the pkl files for prediction purpose
    with open('vectorizer.pkl', 'rb') as f:
        vectorizer_prediction = pickle.load(f)
    with open('dtree.pkl', 'rb') as f:
        dtree_model = pickle.load(f)

    print("Reading pkl files successfull")

    inputdtree= vectorizer_prediction.transform([inputtweet])
    predictt = dtree_model.predict(inputdtree)
